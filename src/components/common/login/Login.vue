<template>
    <div class="login_body">
        <nav-bar class="nav-bar"><div slot="center">登入</div></nav-bar>
        <div>
        ...
        <div class="login_btn">
            <input type="submit" value="登录" @click="lg">
        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            lg(){
                   dr(this.username,this.password).then(res=>{
                       console.log(res)
                      //console.log("---")
